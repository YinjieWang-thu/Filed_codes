...
// Mon Jun 23 15:20:20 2025 by ROOT version 6.32.04
// from TTree BPHY25/
// found on file: data15_Main.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data15_Main.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data15_Main.root");
      }
