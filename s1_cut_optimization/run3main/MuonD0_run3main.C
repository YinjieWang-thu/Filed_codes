...
void MuonD0_run3main()
{
	...
	for (double tem_MuonD0 = MuonD0_MaxOpt; tem_MuonD0 > MuonD0_MinOpt; tem_MuonD0 -= (MuonD0_MaxOpt - MuonD0_MinOpt) / stepnum)
	{
		MuonD0.setRange(MuonD0_Min, tem_MuonD0);
		MuonD02.setRange(MuonD0_Min, tem_MuonD0);// Set cut as tem, which increase gradually
		MuonD03.setRange(MuonD0_Min, tem_MuonD0);
		MuonD04.setRange(MuonD0_Min, tem_MuonD0);
	...
	//	print("numB", numB);// Background number
		...
		print_vectors("result/run3main_result/MuonD0","Psi2s_SfromData", x_Data, y_Data, eventnum);
		drawVectors("result/run3main_result/MuonD0", "MuonD0_merit_max", x_Data, y_Data);
		drawVectors("result/run3main_result/MuonD0_mar", "MuonD0_merit_max_mar", x_Data, y_Data, eventnum);
	}
	MuonD0.setRange(MuonD0_Min, MuonD0_Max);
	MuonD02.setRange(MuonD0_Min, MuonD0_Max);
	MuonD03.setRange(MuonD0_Min, MuonD0_Max);// Reset range for next fit
	MuonD04.setRange(MuonD0_Min, MuonD0_Max);
}
