...
void MuonIso_run3main()
{
	...
	for (double tem_MuonIso = MuonIso_MaxOpt; tem_MuonIso > MuonIso_MinOpt; tem_MuonIso -= (MuonIso_MaxOpt - MuonIso_MinOpt) / stepnum)
	{
		MuonIso.setRange(MuonIso_Min, tem_MuonIso);
		MuonIso2.setRange(MuonIso_Min, tem_MuonIso);
		MuonIso3.setRange(MuonIso_Min, tem_MuonIso);// Set cut as tem, which increase gradually
		MuonIso4.setRange(MuonIso_Min, tem_MuonIso);
	...
	//	print("numB", numB);// Background number
		...
		print_vectors("result/run3main_result/MuonIso","Psi2s_SfromData", x_Data, y_Data, eventnum);
		drawVectors("result/run3main_result/MuonIso", "MuonIso_merit_max", x_Data, y_Data);
		drawVectors("result/run3main_result/MuonIso_mar", "MuonIso_merit_max_mar", x_Data, y_Data, eventnum);
	}
	MuonIso.setRange(MuonIso_Min, MuonIso_Max);
	MuonIso2.setRange(MuonIso_Min, MuonIso_Max);// Reset range for next fit
	MuonIso3.setRange(MuonIso_Min, MuonIso_Max);
	MuonIso4.setRange(MuonIso_Min, MuonIso_Max);
}
