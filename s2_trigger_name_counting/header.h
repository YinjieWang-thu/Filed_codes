...
// Thu Jul 24 20:51:52 2025 by ROOT version 6.32.04
// from TTree BPHY25/
// found on file: data15_red.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data15_red.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data15_red.root");
      }
